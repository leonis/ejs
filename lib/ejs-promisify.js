  ...
  constructor() {
    ...
    */
    ...
    this.compile = (template, opts) => {
      ...
      const fn = new Function('setCookie, redirect, request, requests, includeTemplate, co, escapeFn, rethrow', compileSource); // eslint-disable-line no-new-func
      ...
      return fn.call(self.opts[self.localsName], self.setCookie, self.redirect, self.request, self.requests, self.includeTemplate, co, utils.escapeXML, rethrow);
    };
