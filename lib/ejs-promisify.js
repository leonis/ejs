    ...
    */
    this.includeTemplate = (name) => {
      return co(function * () {
        ...
        const html = yield self.render(template, self.locals, {});
        return html;
      });
    };
    ...
    this.render = (template, locals, opts) => {
      ...
      locals.co = co;
      const fn = new Function('locals, escape, include, rethrow', compileSource); // eslint-disable-line no-new-func
...
/*
      return fn.apply({}, [
        locals, ejs.__get__("utils.escapeXML"),
        include, ejs.__get__("rethrow")
      ]).catch((e) => {
