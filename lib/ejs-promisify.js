  ...
  constructor() {
    ...
    */
    ...
    this.render = (template, locals, opts) => {
      ...
      // 禁止
      // Node.js v4.7.2 https://nodejs.org/dist/latest-v4.x/docs/api/globals.htmlより抜粋
      locals.Buffer = undefined;
      locals.__dirname = undefined;
      locals.__filename = undefined;
      locals.clearImmediate = undefined;
      locals.clearInterval = undefined;
      locals.clearTimeout = undefined;
      locals.console = undefined;
      locals.exports = undefined;
      locals.global = undefined;
      locals.module = undefined;
      locals.process = undefined;
      locals.require = undefined;
      locals.setImmediate = undefined;
      locals.setInterval = undefined;
      locals.setTimeout = undefined;
      // おまけ
      locals.eval = undefined;
      locals.Function = undefined;

      const fn = new Function('locals, redirect, request, requests, includeTemplate, co, escapeFn, rethrow', compileSource); // eslint-disable-line no-new-func
      ...
      return fn.call(null, locals, self.redirect, self.request, self.requests, self.includeTemplate, co, utils.escapeXML, rethrow);
    };
  }
}();
